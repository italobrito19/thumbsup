...
export function Reservas({navigation}) {

  const reservas = {
    'id':'0001',
    'motorista':'Arthur Medeiros',
    'destino':'Butantã',
    'endereco':'Rua Edinaldo',
    'bairro':'Butantã',
    'cidade':'SP',
    'valor':'70',
    'data':'10/10/2020',
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{alignSelf:'flex-start'}} >
        <Text style={styles.titleText}>Reservas ativas:</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.textContent} >#{reservas.id}</Text>
        <Text style={styles.textContent}>Motorista: {reservas.motorista}</Text>
      ...
      >
        <Text style={styles.textButton}> Buscar Carona</Text>
      </TouchableOpacity>
    </View>
  );
}
